...
Sheets are filed by region, `kanto`, `johto` and `hoenn` for the first 386 and
their forms
...
sheet's own `sheet.json`, under `credits`, one list per coat: the 422 sheets that
ship, the 386 of the dex with Unown's 27 other letters, Castform's and Deoxys'
six other shapes, and the three under `unknown`, name their artists in the file
beside the drawing. `pnpm
...
The dex runs to 386, with those species and their moves, abilities and items,
