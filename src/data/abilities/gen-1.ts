...
export default function registerGen1Abilities(): void {
  ...
  registerAbility(Abilities.Boss, {
    name: 'Boss',
    description:
      '60x its own HP, every other stat 2x. Shrugs off disabling statuses, takes at most 200 from any indirect or share-of-HP hit, and heals at most 1,000 HP each second.',
  });
