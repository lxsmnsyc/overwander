 ...
 * a single pure-channel pixel marks each anchor — white the body, red
 * the head, green and blue the two hands. Reading them is how the game
 * knows where to hang a held item or land a hit.
 */
