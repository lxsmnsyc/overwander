...
const TRAINER_QUOTES: Record<TrainerClass, string> = {
  ...
  [TrainerClass.Backpacker]:
    'I have walked further than you have. Sit down, I will show you what I picked up.',
  [TrainerClass.Baker]: 'The ovens are hot and so am I. Ready when you are.',
  [TrainerClass.Clerk]: 'I have filed everything you could throw at me. Try anyway.',
  [TrainerClass.Dancer]: 'Every step of this is practised. Keep up if you can.',
  [TrainerClass.DepotAgent]: 'The train leaves on time. You will not.',
  [TrainerClass.Doctor]: 'I patch trainers up all day. I would rather be the reason one needs it.',
  [TrainerClass.Harlequin]: 'You look serious. Let us fix that.',
  [TrainerClass.Hoopster]: 'I do not miss from out here. Watch.',
  [TrainerClass.Infielder]: 'Hit it anywhere you like. I will be under it.',
  [TrainerClass.Janitor]: 'You would not believe what gets left in the bins. Some of it fights.',
  [TrainerClass.Lady]: 'My garden cost more than your whole journey. So did these.',
  [TrainerClass.Linebacker]: 'Nothing gets past this line. Come and test it.',
  [TrainerClass.Maid]: 'The house is spotless and the afternoon is mine. Let us battle.',
  [TrainerClass.Musician]: 'One song, one battle, same thing. Count me in.',
  [TrainerClass.NurseryAide]: 'I mind twenty of them at once. One of you is nothing.',
  [TrainerClass.Pilot]: 'I fly for a living. Down here I still do not lose.',
  [TrainerClass.Smasher]: 'Serve, return, done. That is how this goes.',
  [TrainerClass.Socialite]: 'I am expected somewhere in an hour. This will not take one.',
  [TrainerClass.Striker]: 'I kick things for a living. Guess what happens next.',
  [TrainerClass.SuitActor]: 'You never know who is really in the costume. Neither do they.',
  [TrainerClass.Veteran]:
    'I have been doing this since before you were born. Let us not drag it out.',
  [TrainerClass.Backers]: 'We cheer all day and we still have more energy than you. Go on.',
  [TrainerClass.UnovaAceTrainer]: 'Unova takes its trainers seriously. I am what that looks like.',
  [TrainerClass.UnovaArtist]: 'I paint what I battle. Hold still.',
  [TrainerClass.UnovaBattleGirl]:
    'I train in the tower every morning. This is the easy part of my day.',
  [TrainerClass.UnovaBeauty]: 'Do not let the outfit fool you. It has never lost either.',
  [TrainerClass.UnovaBiker]: 'This whole road is ours after dark. It is after dark.',
  [TrainerClass.UnovaBlackBelt]: 'Strength is the only thing that carries over. Show me yours.',
  [TrainerClass.UnovaBreeder]: 'I raised every one of these from an egg. They know what I want.',
  [TrainerClass.UnovaCyclist]: 'I came down that hill at speed and I have not stopped.',
  [TrainerClass.UnovaFisherman]: 'Been on this bank since dawn. Something is finally biting.',
  [TrainerClass.UnovaGentleman]: 'A wager, then. Nothing large. Only everything you are carrying.',
  [TrainerClass.UnovaGuitarist]: 'Plug in, turn up, knock down. In that order.',
  [TrainerClass.UnovaHiker]: 'I know every stone on this route by name. They know me too.',
  [TrainerClass.UnovaLass]: 'I have been waiting all morning for somebody to come past!',
  [TrainerClass.UnovaParasolLady]: 'Rain or shine, I am ready for it. Are you?',
  [TrainerClass.UnovaPokeFan]: 'I have photographs of every one of these. Want to be in one?',
  [TrainerClass.UnovaPoliceman]: 'Routine stop. Empty your party, please.',
  [TrainerClass.UnovaPsychic]:
    'I saw this battle before you turned the corner. It went badly for you.',
  [TrainerClass.UnovaRanger]:
    'This stretch is mine to look after. That includes looking after you.',
  [TrainerClass.UnovaRichBoy]: 'Everything I have was bought. Everything they can do was earned.',
  [TrainerClass.UnovaRoughneck]:
    'Shaved head, bad attitude, good pokemon. Two out of three should worry you.',
  [TrainerClass.UnovaSchoolKid]: 'I have done the reading. Now I want the practical.',
  [TrainerClass.UnovaScientist]: 'I am testing something. You are the control.',
  [TrainerClass.UnovaSwimmer]: 'The water is warmer than it looks. Get in.',
  [TrainerClass.UnovaWaiter]: 'Your table is ready. So is my team.',
  [TrainerClass.UnovaWorker]: 'We dug this tunnel by hand. You are standing in it.',
  [TrainerClass.UnovaYoungster]: 'I dug up something great out here. Want to see it swing?',
};
