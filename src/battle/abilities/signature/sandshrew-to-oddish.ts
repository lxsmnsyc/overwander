...
import { createRegalCourtAbility, createUnitCounter } from './__create';
...
const sandshrewToOddish = [
  ...
  // The two Nidoran lines: counterparts, both paid in poison, one on
  // the defending side of a blow and one on the attacking side
  createRegalCourtAbility(Abilities.QueensCourt, 'defends'),
  createRegalCourtAbility(Abilities.KingsCourt, 'attacks'),
