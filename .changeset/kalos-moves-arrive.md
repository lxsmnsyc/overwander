...
- Every move generation 6 introduced is in the move list, from Flying Press to Hyperspace Fury. No pokemon learns one yet, so Metronome is the only way to one for now.
