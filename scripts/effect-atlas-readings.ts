...
const GROUPS: Group[] = [
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/178',
        shows: 'Gold-white starburst opening, then a scatter of orange sparks',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/195',
        shows: 'Orange embers drifting upward in a loose column',
        move: 'Ember',
        plays: 'Target',
        guess: true,
      },
      {
        sheet: 'effects/196',
        shows: 'Orange detonation flaring out into a wide blue-white blast',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/205',
        shows: 'A few orange sparks flicking outward and dying',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/206',
        shows: 'Orange fire blobs splitting apart and drifting off',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/207',
        shows: 'Concentric rings widening from a point, white then red',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/250',
        shows: 'Yellow-orange sparks streaming upward out of frame',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/251',
        shows: 'Flame jet rising off the ground, then embers falling back',
        move: '—',
        plays: 'Field',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/179',
        shows: 'Yellow orb wrapped in blue arcs, then pulsing on its own',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/197',
        shows: 'Yellow orb swelling with lightning zigzagging around it',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/198',
        shows: 'Zigzag sparks converging into one bright orb',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/203',
        shows: 'Lightning striking down, then a ring of sparks on the ground',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/204',
        shows: 'Yellow orb spitting lightning spikes, settling to a plain orb',
        move: '—',
        plays: 'User',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/173',
        shows: 'Blue streaks falling in sheets from above',
        move: 'Rain Dance',
        plays: 'Field',
      },
      {
        sheet: 'effects/174',
        shows: 'Flat cyan ring widening across the ground',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/186',
        shows: 'Ring closing inward onto a small blue orb',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/187',
        shows: 'Blue orb taking star-shaped hits from every side',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/212',
        shows: 'Pale bubbles gathering over a point, then frost puffs',
        move: 'Bubble Beam',
        plays: 'Target',
      },
      {
        sheet: 'effects/218',
        shows: 'White beads falling in a stream, with dust where they land',
        move: 'Hail',
        plays: 'Field',
      },
      {
        sheet: 'effects/222',
        shows: 'White bubbles rising and popping',
        move: 'Bubble',
        plays: 'Target',
      },
      {
        sheet: 'effects/224',
        shows: 'Grey rubble thrown up, then a wide cyan detonation',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/235',
        shows: 'Cyan droplets thrown outward and falling away',
        move: 'Splash',
        plays: 'User',
        guess: true,
      },
  ...
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/184',
        shows: 'Green starburst opening from a point, with motes around it',
        move: 'Absorb',
        note: 'played three ways — on the target, along the trail back, on the caster',
        plays: 'User / Target',
      },
      {
        sheet: 'effects/188',
        shows: 'Green and pink rosette blooming, then a blue jagged ring',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/234',
        shows: 'Gold petals scattering outward',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/245',
        shows: 'Ring of gold petals opening outward',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/247',
        shows: 'Green whirl drawing motes into its centre',
        move: 'Mega Drain',
        plays: 'Target',
      },
      {
        sheet: 'effects/248',
        shows: 'Green spiked bursts multiplying across the cell',
        move: '—',
        plays: 'Target',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/176',
        shows: 'Magenta orb charging with a flashing core, then dispersing',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/177',
        shows: 'Purple crescent with stars turning around it',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/213',
        shows: 'Yellow star swelling into a wide pink starburst',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/214',
        shows: 'Pink oval burst ringed with dots',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/215',
        shows: 'Dark violet sphere with a wavering core, thinning away',
        move: 'Night Shade',
        plays: 'Target',
      },
      {
        sheet: 'effects/217',
        shows: 'Pink hearts rising among yellow sparkles',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/220',
        shows: 'Black orb spiked with white, then a dark turning disc',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/223',
        shows: 'Ring of pink stars opening out into a wide ring',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/231',
        shows: 'Purple cluster around a dark ring, breaking into crescents',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/232',
        shows: 'Magenta starburst inside a pink ring',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/233',
        shows: 'The same burst and ring, ending on a grey orb',
        move: '—',
        note: 'a variant of effects/232',
        plays: 'Target',
      },
      {
        sheet: 'effects/239',
        shows: 'Dark vortex turning, shot through with magenta sparks',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/241',
        shows: 'Violet orb with white streaks flashing off both sides',
        move: '—',
        plays: 'Target',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/219',
        shows: 'Purple gas balls circling outward from a point',
        move: 'Toxic',
        plays: 'Target',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/185',
        shows: 'Open white hand, then a magenta impact burst',
        move: 'Double Slap',
        plays: 'Target',
      },
      {
        sheet: 'effects/191',
        shows: 'Grey burst rimmed with green teeth',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/192',
        shows: 'Violet speed streaks, then sparks and a burst at the end',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/199',
        shows: 'Purple crescent, then brown boulders tumbling in',
        move: 'Rock Throw',
        plays: 'Target',
      },
      {
        sheet: 'effects/201',
        shows: 'Magenta feathered slashes crossing the cell',
        move: 'Wing Attack',
        plays: 'Target',
        guess: true,
      },
      {
        sheet: 'effects/209',
        shows: 'White puffs swelling and scattering',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/216',
        shows: 'Open pink hand, then pink sparks',
        move: 'Pound',
        note: 'pairs with effects/185, the white hand',
        plays: 'Target',
      },
      {
        sheet: 'effects/225',
        shows: 'Grey fan sweeping, with green and blue stars off it',
        move: 'Gust',
        plays: 'Target',
        guess: true,
      },
      {
        sheet: 'effects/226',
        shows: 'Dark chevrons, a violet cross, then blue orbs settling',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/227',
        shows: 'Thin white blades crossing',
        move: 'Cut',
        plays: 'Target',
      },
      {
        sheet: 'effects/240',
        shows: 'White blades crossing, then violet sparkles',
        move: 'Razor Wind',
        plays: 'Target',
        guess: true,
      },
      {
        sheet: 'effects/242',
        shows: 'Parallel claw slashes with red flecks along them',
        move: 'Scratch',
        plays: 'Target',
      },
      {
        sheet: 'effects/243',
        shows: 'White fist, lines radiating off it, then a dark burst',
        move: 'Mega Punch',
        plays: 'Target',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/238',
        shows: 'Dark cogwheel with rings rippling out from it',
        move: '—',
        note: 'the rings Supersonic uses are effects/19 already',
        plays: 'Target',
      },
      {
        sheet: 'effects/246',
        shows: 'Ring of pale diamonds and cogs turning',
        move: '—',
        plays: 'Field',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/175',
        shows: 'White star, then teal ring specks spreading out',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/180',
        shows: 'Loose confetti in many colours drifting down',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/181',
        shows: 'Ring of gold dots, white stars, then a wide pale circle',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/182',
        shows: 'The same ritual, with a bright white flash at its peak',
        move: '—',
        note: 'a variant of effects/181',
        plays: 'User',
      },
      {
        sheet: 'effects/183',
        shows: 'Gold star, a blue orb, then a pale circle opening',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/190',
        shows: 'Yellow four-point stars multiplying across the cell',
        move: '—',
        plays: 'Field',
      },
      {
        sheet: 'effects/193',
        shows: 'Grey figure struck by blue arcs',
        move: '—',
        note: 'candidate for Substitute, if the figure is the doll',
        plays: 'User',
        guess: true,
      },
      {
        sheet: 'effects/194',
        shows: 'Ring of gold stars closing into a burst',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/200',
        shows: 'Gold star, then olive-grey smoke clumps',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/202',
        shows: 'Yellow bars drifting upward',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/208',
        shows: 'Orange sparks among white stars',
        move: '—',
        plays: 'Target',
      },
      {
        sheet: 'effects/210',
        shows: 'Gold disc with violet rings rising off it',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/211',
        shows: 'Small white sparkle bursts',
        move: '—',
        plays: 'User',
      },
      {
        sheet: 'effects/221',
        shows: 'Sparkling diamonds around a pink capsule',
        move: 'Item use',
        plays: 'User',
      },
      {
        sheet: 'effects/228',
        shows: 'Grains falling and gathering into orange clusters, then a red ring',
        move: 'Item use',
        note: 'reads as something eaten — orange of the three',
        plays: 'User',
        guess: true,
      },
      {
        sheet: 'effects/229',
        shows: 'The same grains gathering green, ending on a sparkle',
        move: 'Item use',
        note: 'the green of the three',
        plays: 'User',
        guess: true,
      },
      {
        sheet: 'effects/230',
        shows: 'The same grains gathering gold',
        move: 'Item use',
        note: 'the gold of the three',
        plays: 'User',
        guess: true,
      },
      {
        sheet: 'effects/237',
        shows: 'Soft white orb swelling, sparks turning around it',
        move: 'Recover',
        plays: 'User',
        guess: true,
      },
  ...
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/189',
        shows: 'White pellets rising in a line',
        move: 'Rising pellets',
        plays: 'Target',
      },
      {
        sheet: 'effects/244',
        shows: 'Seeds falling, brown then dark green',
        move: 'Falling seeds',
        plays: 'Target',
      },
      {
        sheet: 'effects/249',
        shows: 'A single small shot crossing, bursting into a white puff',
        move: 'Small shot',
        plays: 'Target',
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        sheet: 'effects/236',
        shows: 'Puffs of white with violet question marks, then a small figure',
        move: 'Confused',
        note: 'a wordier variant of the effects/67 mark',
        plays: 'User',
      },
    ],
  },
