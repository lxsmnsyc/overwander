...
import setupStrengthSap from './strength-sap';
import setupLaserFocus from './laser-focus';
import setupThroatChop from './throat-chop';
import setupPollenPuff from './pollen-puff';
...
import setupTypeMatchups from './type-matchups';
import setupFellStinger from './fell-stinger';
...
export default function setupMoves(battle: Battle): void {
  ...
  setupStrengthSap(battle);
  setupLaserFocus(battle);
  setupThroatChop(battle);
  setupPollenPuff(battle);
