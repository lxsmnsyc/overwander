...
- Migrant's Wind (Taillow): it casts Tailwind over its side as it arrives on the field.
- Gull's Greed (Wingull): every heal an enemy receives is 0.75x, and it takes the quarter for itself.
- Empath (Ralts): its Special Attack counts 1.3x while any ally is below 1/2 HP.
