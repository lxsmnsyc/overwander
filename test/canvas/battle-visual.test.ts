...
const SHAPES: [shape: string, move: Moves][] = [
  ...
  // Alola, and the Z-Moves
  ['Sunsteel', Moves.SunsteelStrike],
  ['Moongeist', Moves.MoongeistBeam],
  ['Photon', Moves.PhotonGeyser],
  ['Prism', Moves.PrismaticLaser],
  ['Enforcer', Moves.CoreEnforcer],
  ['Aurora', Moves.AuroraVeil],
  ['Shackle', Moves.SpiritShackle],
  ['Anchor', Moves.AnchorShot],
  ['Lariat', Moves.DarkestLariat],
  ['Madness', Moves.NaturesMadness],
  ...
  ['Downpour', Moves.AcidDownpour],
  ['Tectonic', Moves.TectonicRage],
  ['Continental', Moves.ContinentalCrush],
  ['Cocoon', Moves.SavageSpinOut],
  ['Nightmare', Moves.NeverEndingNightmare],
  ['Corkscrew', Moves.CorkscrewCrash],
  ['Overdrive', Moves.InfernoOverdrive],
  ['Hydrovortex', Moves.HydroVortex],
  ['Doom', Moves.BloomDoom],
  ['Havoc', Moves.GigavoltHavoc],
  ['Psyche', Moves.ShatteredPsyche],
  ['Slammer', Moves.SubzeroSlammer],
  ['Drake', Moves.DevastatingDrake],
  ['Eclipse', Moves.BlackHoleEclipse],
  ['Twinkle', Moves.TwinkleTackle],
  ['Catastropika', Moves.Catastropika],
  ['ArrowRaid', Moves.SinisterArrowRaid],
  ['Moonsault', Moves.MaliciousMoonsault],
  ['Operetta', Moves.OceanicOperetta],
  ['Sparksurfer', Moves.StokedSparksurfer],
  ['Pancake', Moves.PulverizingPancake],
  ['Evoboost', Moves.ExtremeEvoboost],
  ['Megavolt', Moves.TenMillionVoltThunderbolt],
  ['Snuggle', Moves.LetsSnuggleForever],
  ['Guardian', Moves.GuardianOfAlola],
  ['SevenStar', Moves.SoulStealing7StarStrike],
  ['Supernova', Moves.GenesisSupernova],
  ['Skyburn', Moves.LightThatBurnsTheSky],
  ['Sunraze', Moves.SearingSunrazeSmash],
