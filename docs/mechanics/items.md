...
| **Rare**     | The evolution stones, the Rotom Catalog, the Linking Cord and the items a trade or a held evolution asks for, from a King's Rock to a Razor Fang; Rare Candies, the six vitamins and PP Ups; Nuggets and the richer valuables; Full Restores and Max Revives; the species relics and the Soul Dew; the seventeen plates and the Drives; the choice items, the vest and the Eviolite; the Flame, Toxic and Life Orbs; Leftovers |
