...
export default function registerKeldeoSpecies(): void {
  registerSpecies(Species.Keldeo, KELDEO);
  registerSpecies(Species.KeldeoResolute, {
    ...KELDEO,
    name: 'Keldeo Resolute',
    baseForm: false,
    // Worn rather than met: learning Secret Sword is what brings it
    // out, so the dex fills it in the day Keldeo is
    worn: true,
