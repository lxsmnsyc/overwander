...
import registerDratiniSpecies from './dratini';
...
import registerTaurosSpecies from './tauros';
...
export default function registerGen1Species(): void {
  ...
  registerMrMimeSpecies();
  registerScytherSpecies();
  registerJynxSpecies();
  registerElectabuzzSpecies();
